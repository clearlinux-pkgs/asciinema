...
%prep
%setup -q -n asciinema-2.2.0
cd %{_builddir}/asciinema-2.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652140585
...
cp %{_builddir}/asciinema-2.2.0/LICENSE %{buildroot}/usr/share/package-licenses/asciinema/8624bcdae55baeef00cd11d5dfcfa60f68710a02
